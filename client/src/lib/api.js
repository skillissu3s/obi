...
export const api = {
  ...
  loginCode: (identifier) => request('POST', '/api/auth/login/code', { identifier }),
  verifyLoginCode: (ticket, code) => request('POST', '/api/auth/login/code/verify', { ticket, code }),
  register: (body) => request('POST', '/api/auth/register', body),
  verifyRegistration: (ticket, code) => request('POST', '/api/auth/register/verify', { ticket, code }),
  resendCode: (ticket) => request('POST', '/api/auth/code/resend', { ticket }),
  resetPassword: (identifier) => request('POST', '/api/auth/password/reset', { identifier }),
